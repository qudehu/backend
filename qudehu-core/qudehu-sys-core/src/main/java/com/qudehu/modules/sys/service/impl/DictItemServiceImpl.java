...
import com.qudehu.modules.sys.mapper.DictItemMapper;
import com.qudehu.modules.sys.mapper.DictMapper;
import com.qudehu.modules.sys.service.DictItemService;
import com.qudehu.modules.sys.vo.DictItemVO;
import com.qudehu.util.RedisUtil;
...
public class DictItemServiceImpl extends ServiceImpl<DictItemMapper, DictItem> implements DictItemService {
    ...
    public boolean save(DictItemParam param) {
        com.qudehu.modules.sys.entity.Dict dict = dictMapper.selectById(param.getDictId());
        if(dict == null) return false;
        param.setId(null);
        DictItem dictItem = new DictItem();
        BeanUtils.copyProperties(param, dictItem);
        return RedisUtil.delayedDoubleRemove(dictCache,(com.qudehu.modules.sys.entity.Dict object)->{
    ...
    public boolean removeByIds(Collection<?> list) {
        ...
        List<com.qudehu.modules.sys.entity.Dict> dictList = dictMapper.selectBatchIds(dictItemList.stream().map(item->item.getDictId()).collect(Collectors.toList()));
        return RedisUtil.delayedDoubleRemove(dictCache,(List<com.qudehu.modules.sys.entity.Dict> objects)->{
